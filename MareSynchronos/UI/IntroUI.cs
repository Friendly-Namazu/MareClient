...
public partial class IntroUi : WindowMediatorSubscriberBase
{
    ...
    protected override void DrawInternal()
    {
        ...
        else if (!_uiShared.ApiController.ServerAlive)
        {
            ...
            UiSharedService.TextWrapped("If you want to register at the main server \"" + WebAPI.ApiController.MainServer + "\" join the Discord and follow the instructions as described in #namazu-service.");
